...
for(var i=0;i < movieArray.length;i++){
	...
	result += '<div class="col-sm-4"><figure class="movie"><img src="https://image.tmdb.org/t/p/w1280'+movieArray[i].poster_path+'" alt="" class="img-fluid"><figcaption><div class="movie-info"><div class="row"><div class="col-sm-10"><h3>' +movieArray[i].title+'</h3></div><div class="col-sm-2"><span>'+movieArray[i].vote_average+'</span></div></div></div><div class="overview"><h3>Overview</h3><p class="info">'+movieArray[i].overview+'</p></div></figcaption></figure></div>' ;
